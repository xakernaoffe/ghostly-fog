...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 11 2017 г., 11:44
...
(5, 0, '1f9310m0kfmubmnn4ftiev6nm5', 43, 0, '[]', 12, '2017-07-11 10:51:55');
...
(47, 'Товар 21', '', '', '', '', '', '', '', 1000, 5, 'catalog/hogcob.png', 7, 1, '100.0000', 400, 9, '2009-02-03', '1.00', 1, '0.00', '0.00', '0.00', 1, 0, 1, 0, 1, 188, '2009-02-03 21:08:40', '2017-07-07 18:46:07'),
...
--
ALTER TABLE `oc_dqc_statistic`
  MODIFY `statistic_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=164;
--
...
--
ALTER TABLE `oc_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=119;
--
...
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=303;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3392;
--
