...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 17 2017 г., 14:24
...
(4, 'Гривна', 'UAH', '', ' грн', '0', 1.00000000, 1, '2017-07-17 12:51:46');
...
(199, 1, 'slideshow.36', 'content_top', 0),
(163, 2, 'featured.28', 'content_bottom', 0),
(159, 3, 'category', 'column_left', 1),
(198, 1, 'carousel.29', 'content_bottom', 0),
(197, 1, 'bestseller.34', 'content_top', 2),
(158, 3, 'ocfilter', 'column_left', 2),
(196, 1, 'latest.33', 'content_top', 1),
(195, 1, 'videopublisherwidget.32', 'content_top', 3);
...
) ENGINE=MyISAM AUTO_INCREMENT=3670 DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `oc_ocfilter_option_value_to_product`
  MODIFY `ocfilter_option_value_to_product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=97;
--
...
--
ALTER TABLE `oc_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=145;
--
...
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=356;
--
...
--
ALTER TABLE `oc_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2445;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3670;
--
