...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 31 2017 г., 12:25
...
(30, 'New синий', 'catalog/label/new-blue.png', 2),
...
(40, 'Hit Default', 'catalog/label/hitIcon.png', 2),
...
(60, 'New Default', 'catalog/label/newIcon.png', 0),
...
(4, 42, 31, 'rb-tr', '2017-07-30 00:00:00', '2017-07-31 00:00:00'),
...
(54, 1, 'coch7oooqc35oijurormt5hn13', 46, 0, '[]', 3, '2017-07-22 17:33:48'),
(56, 1, 'coch7oooqc35oijurormt5hn13', 47, 0, '[]', 1, '2017-07-27 15:34:45'),
(59, 0, 'coch7oooqc35oijurormt5hn13', 47, 0, '[]', 1, '2017-07-31 11:57:00');
...
(1, 'Рубль', 'RUB', '', ' р.', '2', 2.29889989, 1, '2017-07-30 21:41:20'),
(2, 'US Dollar', 'USD', '$', '', '2', 0.03860000, 1, '2017-07-30 21:41:20'),
(3, 'Euro', 'EUR', '', '€', '2', 0.03280000, 1, '2017-07-30 21:41:20'),
(4, 'Гривна', 'UAH', '', ' грн', '0', 1.00000000, 1, '2017-07-31 12:05:11');
...
(22, 1, 22, 0, '{"account":"guest","field":{"guest":{"payment_address":4,"shipping_address":7,"confirm":1},"register":{"payment_address":6,"shipping_address":7,"confirm":1},"logged":{"payment_address":2,"shipping_address":7,"confirm":1}},"click":{"login":4,"cart":2},"update":{"shipping_method":14}}', 0, '2017-07-27 15:36:10', '2017-07-31 01:27:43');
...
INSERT INTO `oc_modification` (`modification_id`, `name`, `code`, `author`, `version`, `link`, `xml`, `status`, `date_added`) VALUES
(18, 'Стикеры на товары', 'opencartart_promotion_label_pro_ocmod_1000', 'opencart2x.ru', '2.2', 'https://opencart2x.ru', '<modification>\r\n    <name>Стикеры на товары</name>\r\n    <version>2.2</version>\r\n    <link>https://opencart2x.ru</link>\r\n    <author>opencart2x.ru</author>\r\n    <code>opencartart_promotion_label_pro_ocmod_1000</code>\r\n    <file path="admin/controller/common/menu.php">\r\n        <operation>\r\n            <search><![CDATA[\r\n            $data[''customer'']\r\n            ]]></search>\r\n            <add position="before"><![CDATA[\r\n            if(version_compare(VERSION, ''2.2.0.0'', ''<'') == true) {\r\n                $text_ssl = ''SSL'';\r\n            } else {\r\n                $text_ssl = true;\r\n            }\r\n            $data[''text_promotion_label_pro''] = ''Стикеры'';\r\n            $data[''text_label_manager''] = ''Менеджер стикеров'';\r\n            $data[''text_product_to_label''] = ''Товары со стикерами'';\r\n            $data[''label_manager''] = $this->url->link(''catalog/promotion_label_pro'', ''token='' . $this->session->data[''token''], $text_ssl);\r\n            $data[''product_to_label''] = $this->url->link(''catalog/promotion_label_to_product'', ''token='' . $this->session->data[''token''], $text_ssl);\r\n            ]]></add>\r\n        </operation>\r\n    </file>  \r\n    <file path="admin/view/template/common/menu.tpl">\r\n        <operation>\r\n            <search><![CDATA[\r\n            <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>\r\n            ]]></search>\r\n            <add position="after"><![CDATA[\r\n            <li><a class="parent"><?php echo $text_promotion_label_pro; ?></a>\r\n                <ul>\r\n                    <li><a href="<?php echo $label_manager; ?>"><?php echo $text_label_manager; ?></a></li>\r\n                    <li><a href="<?php echo $product_to_label; ?>"><?php echo $text_product_to_label; ?></a></li>\r\n                </ul>\r\n            </li>\r\n            ]]></add>\r\n        </operation>\r\n    </file>\r\n    <file path="catalog/controller/product/category.php">\r\n        <operation>\r\n            <search><![CDATA[\r\n            public function index() {\r\n            ]]></search>\r\n            <add position="after"><![CDATA[\r\n            $this->document->addStyle(''catalog/view/javascript/promotionlabelpro/style.css'');\r\n            ]]></add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $results = $this->model_catalog_product->getProducts($filter_data);\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->load->model(''catalog/promotion_label_product'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $data[''products''][] = array(\r\n                ]]>\r\n            </search>\r\n            <add position="before">\r\n                <![CDATA[\r\n                $labels = array();\r\n                $labels = $this->model_catalog_promotion_label_product->getProductLabel($result[''product_id'']);\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                ''rating''      => $result[''rating''],\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                ''labels''   => $labels,\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/view/theme/default/template/product/category.tpl">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[<div class="image">]]>\r\n            </search>\r\n            <add position="replace">\r\n                <![CDATA[\r\n                <div class="image">\r\n                <?php if($product[''labels'']) { ?>\r\n                <?php foreach ($product[''labels''] as $label) { ?>\r\n                <div class="<?php echo $label[''position'']; ?>"><img src="<?php echo HTTP_SERVER.''image/''.$label[''image'']; ?>"></div>\r\n                <?php } ?>\r\n                <?php } ?>\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file> \r\n\r\n    <file path="catalog/controller/product/manufacturer.php">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                public function info() {\r\n                ]]>\r\n            </search>\r\n            <add  position="after">\r\n                <![CDATA[\r\n                $this->document->addStyle(''catalog/view/javascript/promotionlabelpro/style.css'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $results = $this->model_catalog_product->getProducts($filter_data);\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->load->model(''catalog/promotion_label_product'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $data[''products''][] = array(\r\n                ]]>\r\n            </search>\r\n            <add position="before">\r\n                <![CDATA[\r\n                $labels = array();\r\n                $labels = $this->model_catalog_promotion_label_product->getProductLabel($result[''product_id'']);\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                ''rating''      => $result[''rating''],\r\n                ]]>\r\n            </search>\r\n            <add  position="after">\r\n                <![CDATA[\r\n                ''labels''   => $labels,\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/view/theme/default/template/product/manufacturer_info.tpl">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[<div class="image">]]>\r\n            </search>\r\n            <add  position="replace">\r\n                <![CDATA[\r\n                <div class="image">\r\n                <?php if($product[''labels'']) { ?>\r\n                <?php foreach ($product[''labels''] as $label) { ?>\r\n                <div class="<?php echo $label[''position'']; ?>"><img src="<?php echo HTTP_SERVER.''image/''.$label[''image'']; ?>"></div>\r\n                <?php } ?>\r\n                <?php } ?>\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/controller/product/search.php">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                public function index() {\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->document->addStyle(''catalog/view/javascript/promotionlabelpro/style.css'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $results = $this->model_catalog_product->getProducts($filter_data);\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->load->model(''catalog/promotion_label_product'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $data[''products''][] = array(\r\n                ]]>\r\n            </search>\r\n            <add position="before">\r\n                <![CDATA[\r\n                $labels = array();\r\n                $labels = $this->model_catalog_promotion_label_product->getProductLabel($result[''product_id'']);\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                ''rating''      => $result[''rating''],\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                ''labels''   => $labels,\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/view/theme/default/template/product/search.tpl">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[<div class="image">]]>\r\n            </search>\r\n            <add position="replace">\r\n                <![CDATA[\r\n                <div class="image">\r\n                <?php if($product[''labels'']) { ?>\r\n                <?php foreach ($product[''labels''] as $label) { ?>\r\n                <div class="<?php echo $label[''position'']; ?>"><img src="<?php echo HTTP_SERVER.''image/''.$label[''image'']; ?>"></div>\r\n                <?php } ?>\r\n                <?php } ?>\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n    \r\n    <file path="catalog/controller/product/special.php">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                public function index() {\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->document->addStyle(''catalog/view/javascript/promotionlabelpro/style.css'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $results = $this->model_catalog_product->getProductSpecials($filter_data);\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->load->model(''catalog/promotion_label_product'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $data[''products''][] = array(\r\n                ]]>\r\n            </search>\r\n            <add position="before">\r\n                <![CDATA[\r\n                $labels = array();\r\n                $labels = $this->model_catalog_promotion_label_product->getProductLabel($result[''product_id'']);\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                ''rating''      => $result[''rating''],\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                ''labels''   => $labels,\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/view/theme/default/template/product/special.tpl">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[<div class="image">]]>\r\n            </search>\r\n            <add position="replace">\r\n                <![CDATA[\r\n                <div class="image">\r\n                <?php if($product[''labels'']) { ?>\r\n                <?php foreach ($product[''labels''] as $label) { ?>\r\n                <div class="<?php echo $label[''position'']; ?>"><img src="<?php echo HTTP_SERVER.''image/''.$label[''image'']; ?>"></div>\r\n                <?php } ?>\r\n                <?php } ?>\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/controller/module/{latest,featured,bestseller,special}.php">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                public function index($setting) {\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->document->addStyle(''catalog/view/javascript/promotionlabelpro/style.css'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $this->load->model(''tool/image'');\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                $this->load->model(''catalog/promotion_label_product'');\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                ''price''       => $price,\r\n                ]]>\r\n            </search>\r\n            <add position="after">\r\n                <![CDATA[\r\n                ''labels''   => $labels,\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/controller/module/{latest,bestseller,special}.php">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $data[''products''][] = array(\r\n                ]]>\r\n            </search>\r\n            <add position="before">\r\n                <![CDATA[\r\n                $labels = array();\r\n                $labels = $this->model_catalog_promotion_label_product->getProductLabel($result[''product_id'']);\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n    <file path="catalog/controller/module/featured.php">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[\r\n                $data[''products''][] = array(\r\n                ]]>\r\n            </search>\r\n            <add position="before">\r\n                <![CDATA[\r\n                $labels = array();\r\n                $labels = $this->model_catalog_promotion_label_product->getProductLabel($product_info[''product_id'']);\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n\r\n    <file path="catalog/view/theme/default/template/module/{latest,featured,bestseller,special}.tpl">\r\n        <operation>\r\n            <search>\r\n                <![CDATA[<div class="image">]]>\r\n            </search>\r\n            <add position="replace">\r\n                <![CDATA[\r\n                <div class="image">\r\n                <?php if($product[''labels'']) { ?>\r\n                <?php foreach ($product[''labels''] as $label) { ?>\r\n                <div class="<?php echo $label[''position'']; ?>"><img src="<?php echo HTTP_SERVER.''image/''.$label[''image'']; ?>"></div>\r\n                <?php } ?>\r\n                <?php } ?>\r\n                ]]>\r\n            </add>\r\n        </operation>\r\n    </file>\r\n\r\n</modification>', 0, '2017-07-30 21:52:22'),
(20, 'Product statuses', 'Product statuses', 'sv2109', '2.0', 'http://sv2109.com', '<modification>\r  <code>Product statuses</code>\r  <name>Product statuses</name>\r  <version>2.0</version>\r  <author>sv2109</author>\r  <link>http://sv2109.com</link>\r  \r  <file path="system/library/customer.php">\r    <operation>\r      <search><![CDATA[\rpublic function getId() {\r      ]]></search>\r      <add position="before"><![CDATA[\rpublic function getCustomerGroupId() {\r  return $this->getId();\r}\r      ]]></add>\r    </operation>		\r  </file>\r    \r  <file path="catalog/controller/common/header.php">\r    <operation>\r      <search><![CDATA[\r$data[''styles''] = $this->document->getStyles();\r      ]]></search>\r      <add position="before"><![CDATA[\r$this->document->addStyle(''catalog/view/theme/default/stylesheet/product_statuses.css'');\r      ]]></add>\r    </operation>		\r  </file>\r\r  <file path="catalog/controller/product/product.php">\r    <operation>\r      <search><![CDATA[\rif ($product_info) {        \r      ]]></search>\r      <add position="after"><![CDATA[\r$data[''statuses''] =  $product_info[''statuses''][''product''];\r$data[''stickers''] =  $product_info[''statuses''][''product_stickers''];        \r      ]]></add>\r    </operation>		\r  </file>\r\r  <file path="catalog/controller/product/category.php">\r    <operation>\r      <search><![CDATA[\r$data[''products''][] = array(\r      ]]></search>\r      <add position="after"><![CDATA[\r''statuses''    => $result[''statuses''][''category''],\r''stickers''    => $result[''statuses''][''category_stickers''],        \r      ]]></add>\r    </operation>		\r  </file>\r\r  <file path="catalog/model/catalog/product.php">\r    <operation>\r      <search><![CDATA[\rpublic function getProduct($product_id) {        \r      ]]></search>\r      <add position="after"><![CDATA[\r$this->load->model(''catalog/product_status'');\r      ]]></add>\r    </operation>\r    <operation>\r      <search><![CDATA[\rreturn array(        \r      ]]></search>\r      <add position="after"><![CDATA[\r''statuses'' => $this->model_catalog_product_status->getHTMLProductStatuses($query->row),\r      ]]></add>\r    </operation>    		\r  </file>\r\r  <file path="admin/controller/catalog/product.php">\r    <operation>\r      <search><![CDATA[\r$this->response->setOutput($this->load->view(''catalog/product_form.tpl'', $data));\r      ]]></search>\r      <add position="before"><![CDATA[\r		\r		$this->load->language(''module/product_status'');\r		$data[''status_show_in_category''] = $this->language->get(''status_show_in_category'');\r		$data[''status_show_in_product''] = $this->language->get(''status_show_in_product'');\r		$data[''tab_statuses''] = $this->language->get(''tab_statuses'');\r		$data[''status_image''] = $this->language->get(''status_image'');\r		$data[''status_name''] = $this->language->get(''status_name'');\r		$data[''button_add_status''] = $this->language->get(''button_add_status'');\r	\r		$this->load->model(''catalog/product_status'');\r		if (isset($this->request->get[''product_id''])) {\r			$data[''product_statuses''] = $this->model_catalog_product_status->getProductStatuses($this->request->get[''product_id'']);\r		} else {\r			$data[''product_statuses''] = array();\r		}\r\r      ]]></add>\r    </operation>		\r  </file>\r\r  <file path="admin/model/catalog/product.php">\r    <operation>\r      <search><![CDATA[\rpublic function editProduct($product_id, $data) {       \r      ]]></search>\r      <add position="after"><![CDATA[\r		\r		$this->load->model(''catalog/product_status'');\r		$this->model_catalog_product_status->addProductStatuses($product_id, $data);\r		\r      ]]></add>\r    </operation>		\r    <operation>\r      <search><![CDATA[\rpublic function deleteProduct($product_id) {        \r      ]]></search>\r      <add position="after"><![CDATA[\r		\r		$this->load->model(''catalog/product_status'');\r		$this->model_catalog_product_status->deleteProductStatuses($product_id);\r		\r      ]]></add>\r    </operation>		\r    <operation>\r      <search><![CDATA[\r$product_id = $this->db->getLastId();\r      ]]></search>\r      <add position="after"><![CDATA[\r		\r		$this->load->model(''catalog/product_status'');\r		$this->model_catalog_product_status->addProductStatuses($product_id, $data);\r		\r      ]]></add>\r    </operation>		\r    <operation>\r      <search><![CDATA[\r$data[''product_recurrings''] = $this->getRecurrings($product_id);\r      ]]></search>\r      <add position="after"><![CDATA[\r		\r		$this->load->model(''catalog/product_status'');\r    $data[''product_status''] = $this->model_catalog_product_status->getProductStatuses($product_id);\r      ]]></add>\r    </operation>		\r  </file>\r\r  <file path="admin/view/template/catalog/product_form.tpl">\r    <operation>\r      <search><![CDATA[\r<div class="tab-pane" id="tab-discount">        \r      ]]></search>\r      <add position="before"><![CDATA[\r        <div class="tab-pane" id="tab-statuses">\r\r          <table id="status" class="table table-striped table-bordered table-hover">\r            <thead>\r              <tr>\r                <td></td>\r                <td class="left"><?php echo $status_image; ?></td>\r                <td class="left"><?php echo $status_show_in_category; ?></td>\r                <td class="left"><?php echo $status_show_in_product; ?></td>\r                <td class="left"><?php echo $entry_sort_order; ?></td>\r                <td></td>\r              </tr>\r            </thead>\r            <?php $status_row = 0; ?>\r            <?php foreach ($product_statuses as $product_status) { ?>\r            <tbody id="status-row<?php echo $status_row; ?>">\r              <tr>\r                <td class="left">\r                  <input type="text" name="product_status[<?php echo $status_row; ?>][name]" value="<?php echo $product_status[''name'']; ?>" class="form-control"/>\r                  <input type="hidden" name="product_status[<?php echo $status_row; ?>][status_id]" value="<?php echo $product_status[''status_id'']; ?>" /> \r                  <input type="hidden" name="product_status[<?php echo $status_row; ?>][thumb]" value="<?php echo $product_status[''thumb'']; ?>" />\r                </td>\r                <td class="left status-image">\r                  <img src=''<?php echo $product_status[''thumb'']; ?>'' ?>\r                </td>\r                <td class="left status-category">\r                  <input type="checkbox" name="product_status[<?php echo $status_row; ?>][category_show]" value="1" <?php echo isset($product_status[''category_show'']) && $product_status[''category_show''] ? "checked=''checked''" : ''''; ?> class="form-control" />\r                </td>\r                <td class="left status-product">\r                  <input type="checkbox" name="product_status[<?php echo $status_row; ?>][product_show]" value="1" <?php echo isset($product_status[''product_show'']) && $product_status[''product_show''] ? "checked=''checked''" : ''''; ?> class="form-control" />\r                </td>\r                <td class="left sort-order">\r                  <input type="text" name="product_status[<?php echo $status_row; ?>][sort_order]" value="<?php echo isset($product_status[''sort_order'']) ? $product_status[''sort_order''] : ''''; ?>" class="form-control" />\r                </td>\r                <td class="left"><a onclick="$(''#status-row<?php echo $status_row; ?>'').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></a>\r                </td>\r              </tr>\r            </tbody>\r            <?php $status_row++; ?>\r            <?php } ?>\r            <tfoot>\r              <tr>\r                <td colspan="5"></td>\r                <td class="text-left">\r                  <!--<a onclick="addStatus();" class="button">                    <?php echo $button_add_status; ?></a>-->\r                  <button type="button" onclick="addStatus()" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="<?php echo $button_add_status; ?>"><i class="fa fa-plus-circle"></i></button>\r                </td>\r              </tr>\r            </tfoot>\r          </table>\r<script type="text/javascript"><!--\r$(document).ready(function() {\r  $(''ul.nav-tabs li a[href="#tab-discount"]'').parent().before(''<li><a href="#tab-statuses" data-toggle="tab"><?php echo $tab_statuses; ?></a></li>''); \r});\r  \rvar status_row = <?php echo $status_row; ?>;\r\rfunction addStatus() {\r	html  = ''<tbody id="status-row'' + status_row + ''">'';\r    html += ''  <tr>'';\r	  html += ''    <td class="left"><input type="text" name="product_status['' + status_row + ''][name]" value="" class="form-control" /><input type="hidden" name="product_status['' + status_row + ''][status_id]" value="" /><input type="hidden" name="product_status['' + status_row + ''][thumb]" value="" /></td>'';\r    html += ''    <td class="left status-image"></td>'';\r    html += ''    <td class="left status-category"><input type="checkbox" name="product_status['' + status_row + ''][category_show]" value="1" checked="checked" class="form-control" /></td>'';\r    html += ''    <td class="left status-product"><input type="checkbox" name="product_status['' + status_row + ''][product_show]" value="1" checked="checked" class="form-control" /></td>'';\r    html += ''    <td class="left sort-order"><input type="text" name="product_status['' + status_row + ''][sort_order]" value="" class="form-control" /></td>'';\r		html += ''    <td class="left"><a onclick="$(\\''#status-row'' + status_row + ''\\'').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></a></td>'';\r    html += ''  </tr>'';	\r    html += ''</tbody>'';\r	\r	$(''#status tfoot'').before(html);\r	\r	statusautocomplete(status_row);\r	\r	status_row++;\r}\r\rfunction statusautocomplete(status_row) {\r	$(''input[name=\\''product_status['' + status_row + ''][name]\\'']'').autocomplete({\r		delay: 500,\r		source: function(request, response) {\r			$.ajax({\r				url: ''index.php?route=module/product_status/autocomplete&token=<?php echo $token; ?>&filter_name='' +  encodeURIComponent(request),\r				dataType: ''json'',\r				success: function(json) {	\r					response($.map(json, function(item) {\r						return {\r							url: item[''url''],\r              thumb: item[''thumb''],\r							label: item[''name''],\r							value: item[''status_id'']\r						}\r					}));\r				}\r			});\r		}, \r		select: function(item) {\r			$(''input[name=\\''product_status['' + status_row + ''][name]\\'']'').attr(''value'', item[''label'']);\r			$(''input[name=\\''product_status['' + status_row + ''][status_id]\\'']'').attr(''value'', item[''value'']);\r      $(''input[name=\\''product_status['' + status_row + ''][thumb]\\'']'').attr(''value'', item[''thumb'']);\r      $(''#status-row'' + status_row + '' td.status-image'').html(''<img src="'' + item[''thumb''] + ''"/>'');\r\r			return false;\r		},\r		focus: function(event, ui) {\r      		return false;\r   		}\r	});\r  \r}\r\r$(''#status tbody'').each(function(index, element) {\r	statusautocomplete(index);\r});\r  \r//--></script> \r          \r        </div>\r\r      ]]></add>\r    </operation>		\r  </file>\r\r</modification>', 1, '2017-07-30 23:43:39'),
...
(1, 1, 'catalog/news1.png', '2017-07-04', 38),
...
(188, 42, 5, 42, '0.0000', '0.0000'),
(187, 42, 5, 41, '0.0000', '0.0000'),
(186, 42, 5, 40, '0.0000', '0.0000'),
(185, 42, 5, 39, '0.0000', '0.0000'),
(184, 42, 30003, 3457655122, '0.0000', '0.0000'),
(183, 42, 2, 45, '0.0000', '0.0000'),
(182, 42, 2, 44, '0.0000', '0.0000'),
(181, 42, 2, 24, '0.0000', '0.0000'),
(180, 42, 2, 23, '0.0000', '0.0000'),
(179, 42, 1, 43, '0.0000', '0.0000'),
(178, 42, 1, 31, '0.0000', '0.0000'),
...
(174, 47, 30002, 2367533627, '0.0000', '0.0000'),
(18, 43, 30004, 1667934346, '0.0000', '0.0000'),
(177, 42, 1, 32, '0.0000', '0.0000'),
(173, 47, 30004, 4229265604, '0.0000', '0.0000'),
(172, 47, 30001, 4252452536, '0.0000', '0.0000');
...
(22, 0, 'INV-2016-00', 0, 'Ghostly fog', 'http://ghostly-fog/', 0, 1, '', '', 'alena.makarova1508@gmail.com', '', '', '[]', '', '', '', '', '', '', '', 'Украина', 220, 'Харьков', 3487, '{firstname} {lastname}\n{company}\n{address_1}\n{address_2}\n{city} {postcode}\n{zone}\n{country}', '[]', 'Оплата при получении', 'cod', '', '', '', '', '', '', '', 'Украина', 220, 'Харьков', 3487, '{firstname} {lastname}\n{company}\n{address_1}\n{address_2}\n{city} {postcode}\n{zone}\n{country}', '[]', 'Новая Почта', 'dostavkaplus.sh1', '', '80.0000', 0, 0, '0.0000', 0, '', 1, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-07-31 12:07:34', '2017-07-31 12:07:34');
...
(286, 22, 47, 'HP LP3065', 'Товар 21', 1, '50.0000', '50.0000', '0.0000', 300),
...
(624, 22, 'shipping', 'Новая Почта', '30.0000', 3),
(625, 22, 'total', 'Итого', '80.0000', 9),
(623, 22, 'sub_total', 'Предварительная стоимость', '50.0000', 1);
...
(30, 'Товар 3', '', '', '', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 0, 1, 35, '2009-02-03 16:59:00', '2017-07-26 12:33:15'),
...
(42, 'Товар 15', '', '', '', '', '', '', '', 990, 5, 'catalog/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50', 1, '1.00', '2.00', '3.00', 1, 1, 2, 0, 1, 101, '2009-02-03 21:07:37', '2017-07-30 23:45:59'),
(43, 'Товар 16', '', '', '', '', '', '', '', 908, 5, 'catalog/demo/macbook_1.jpg', 8, 0, '500.0000', 0, 9, '2009-02-03', '0.00', 1, '0.00', '0.00', '0.00', 2, 1, 1, 0, 1, 95, '2009-02-03 21:07:49', '2011-09-30 01:05:46'),
...
(47, 'Товар 21', '', '', '', '', '', '', '', 1000, 5, 'catalog/hogcob.png', 8, 1, '100.0000', 400, 9, '2009-02-03', '1.00', 1, '0.00', '0.00', '0.00', 1, 0, 1, 0, 1, 257, '2009-02-03 21:08:40', '2017-07-26 12:32:56'),
(48, 'Товар 20', 'test 1', '', '', '', '', '', 'test 2', 972, 5, 'catalog/morningdaw.png', 8, 1, '100.0000', 0, 9, '2009-02-08', '1.00', 1, '0.00', '0.00', '0.00', 2, 1, 1, 0, 1, 136, '2009-02-08 17:21:51', '2017-07-19 12:18:32'),
(49, 'SAM1', '', '', '', '', '', '', '', 0, 8, 'catalog/kiloblack.png', 0, 1, '199.9900', 0, 9, '2011-04-25', '0.00', 1, '0.00', '0.00', '0.00', 1, 1, 1, 1, 1, 14, '2011-04-26 08:57:34', '2017-07-03 16:17:37');
...
(2496, 47, 'catalog/beardwape.png', 4),
...
(2503, 42, 'catalog/demo/canon_eos_5d_1.jpg', 0),
(2502, 42, 'catalog/demo/compaq_presario.jpg', 0),
(2501, 42, 'catalog/demo/hp_1.jpg', 0),
(2500, 42, 'catalog/demo/canon_logo.jpg', 0),
(2499, 42, 'catalog/demo/canon_eos_5d_2.jpg', 0),
(2495, 47, 'catalog/productthumb4.png', 3),
(2494, 47, 'catalog/productthumb3.png', 2),
(2493, 47, 'catalog/productthumb2.png', 1),
(2492, 47, 'catalog/productthub1.png', 0);
...
(22, 228, 48, 2, 44, 10, 1, '10.0000', '+', 0, '+', '5.00', '+'),
...
(463, 42, 1, 1, '90.0000', '0000-00-00', '0000-00-00'),
(462, 30, 1, 2, '90.0000', '0000-00-00', '0000-00-00'),
(461, 30, 1, 1, '80.0000', '0000-00-00', '0000-00-00'),
(460, 47, 1, 1, '50.0000', '2017-07-04', '2017-08-06');
...
) ENGINE=MyISAM AUTO_INCREMENT=4274 DEFAULT CHARSET=utf8;
...
(4224, 0, 'config', 'config_owner', 'Мое Имя', 0),
(4225, 0, 'config', 'config_address', '', 0),
(3954, 0, 'ulogin_sets', 'ulogin_sets_group', '2', 0),
(3953, 0, 'ulogin_sets', 'ulogin_sets_uloginid', 'a1fe0f24', 0),
(4223, 0, 'config', 'config_name', 'Ghostly fog', 0),
(4222, 0, 'config', 'config_meta_keyword', '', 0),
(4204, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(4205, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(4221, 0, 'config', 'config_meta_description', 'Интернет магазин электронных сигарет и жидкостей в Украине.', 0),
(4220, 0, 'config', 'config_meta_title', 'Ghostly fog. Залил и запарил!', 0),
(4219, 0, 'config', 'config_sms_gate_password', '', 0),
(4218, 0, 'config', 'config_sms_gate_username', '', 0),
(4217, 0, 'config', 'config_sms_message', '', 0),
(4216, 0, 'config', 'config_sms_copy', '', 0),
(4215, 0, 'config', 'config_sms_to', '', 0),
(4214, 0, 'config', 'config_sms_from', '', 0),
(4206, 0, 'config', 'config_error_display', '1', 0),
(4207, 0, 'config', 'config_error_log', '1', 0),
(4208, 0, 'config', 'config_error_filename', 'error.log', 0),
(4209, 0, 'config', 'config_google_captcha_public', '', 0),
(4210, 0, 'config', 'config_google_captcha_secret', '', 0),
(4211, 0, 'config', 'config_google_captcha_status', '0', 0),
(4212, 0, 'config', 'config_sms_alert', '0', 0),
(4213, 0, 'config', 'config_sms_gatename', 'testsms', 0),
(4203, 0, 'config', 'config_file_max_size', '300000', 0),
(4197, 0, 'config', 'config_mail_regexp', '/^[^@]+@.*.[a-z]{2,15}$/i', 0),
(4198, 0, 'config', 'config_editor_default', '0', 0),
(4199, 0, 'config', 'config_secure', '0', 0),
(4200, 0, 'config', 'config_password', '1', 0),
(4201, 0, 'config', 'config_shared', '0', 0),
...
(4196, 0, 'config', 'config_compression', '0', 0),
(4195, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(4194, 0, 'config', 'config_seo_url_postfix', '', 0),
(4191, 0, 'config', 'config_seo_url', '1', 0),
(4192, 0, 'config', 'config_seo_url_type', 'seo_pro', 0),
(4193, 0, 'config', 'config_seo_url_include_path', '1', 0),
(4190, 0, 'config', 'config_maintenance', '1', 0),
(4189, 0, 'config', 'config_mail_alert', '', 0),
(4188, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(4187, 0, 'config', 'config_mail_smtp_port', '25', 0),
(4186, 0, 'config', 'config_mail_smtp_password', '', 0),
(4185, 0, 'config', 'config_mail_smtp_username', '', 0),
(4184, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(4183, 0, 'config', 'config_mail_parameter', '', 0),
(4182, 0, 'config', 'config_mail_protocol', 'mail', 0),
(4181, 0, 'config', 'config_ftp_status', '0', 0),
(4180, 0, 'config', 'config_ftp_root', '', 0),
(4179, 0, 'config', 'config_ftp_password', '', 0),
(4178, 0, 'config', 'config_ftp_username', '', 0),
(4177, 0, 'config', 'config_ftp_port', '21', 0),
(4176, 0, 'config', 'config_ftp_hostname', 'ghostly-fog', 0),
(4173, 0, 'config', 'config_image_cart_height', '47', 0),
(4174, 0, 'config', 'config_image_location_width', '268', 0),
(4175, 0, 'config', 'config_image_location_height', '50', 0),
(4172, 0, 'config', 'config_image_cart_width', '47', 0),
(4171, 0, 'config', 'config_image_wishlist_height', '47', 0),
(4170, 0, 'config', 'config_image_wishlist_width', '47', 0),
(4169, 0, 'config', 'config_image_compare_height', '90', 0),
(4168, 0, 'config', 'config_image_compare_width', '90', 0),
(4167, 0, 'config', 'config_image_related_height', '80', 0),
(4166, 0, 'config', 'config_image_related_width', '80', 0),
(4165, 0, 'config', 'config_image_additional_height', '104', 0),
(4164, 0, 'config', 'config_image_additional_width', '90', 0),
(4163, 0, 'config', 'config_image_product_height', '260', 0),
(4157, 0, 'config', 'config_image_category_height', '80', 0),
(4158, 0, 'config', 'config_image_thumb_width', '438', 0),
(4159, 0, 'config', 'config_image_thumb_height', '495', 0),
(4160, 0, 'config', 'config_image_popup_width', '500', 0),
(4161, 0, 'config', 'config_image_popup_height', '500', 0),
(4162, 0, 'config', 'config_image_product_width', '260', 0),
(4154, 0, 'config', 'config_logo', 'catalog/logotip.png', 0),
...
(4156, 0, 'config', 'config_image_category_width', '80', 0),
(4155, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(4153, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
(4152, 0, 'config', 'config_captcha', '', 0),
(4151, 0, 'config', 'config_return_status_id', '2', 0),
(4150, 0, 'config', 'config_return_id', '0', 0),
(4149, 0, 'config', 'config_affiliate_mail', '0', 0),
(4148, 0, 'config', 'config_affiliate_id', '4', 0),
(4147, 0, 'config', 'config_affiliate_commission', '5', 0),
(4146, 0, 'config', 'config_affiliate_auto', '0', 0),
(4145, 0, 'config', 'config_affiliate_approval', '0', 0),
(4144, 0, 'config', 'config_stock_checkout', '0', 0),
(4143, 0, 'config', 'config_stock_warning', '0', 0),
(4141, 0, 'config', 'config_api_id', '1', 0),
(4142, 0, 'config', 'config_stock_display', '0', 0),
(4140, 0, 'config', 'config_order_mail', '0', 0),
(4139, 0, 'config', 'config_fraud_status_id', '2', 0),
...
(4268, 0, 'bank_transfer', 'bank_transfer_bank1', 'аеранокенононон', 0),
...
(4138, 0, 'config', 'config_complete_status', '["3","5"]', 1),
(4137, 0, 'config', 'config_processing_status', '["2","3","1","12","5"]', 1),
(4136, 0, 'config', 'config_order_status_id', '1', 0),
(4135, 0, 'config', 'config_checkout_id', '5', 0),
(4134, 0, 'config', 'config_checkout_guest', '1', 0),
...
(4133, 0, 'config', 'config_cart_weight', '1', 0),
(4132, 0, 'config', 'config_invoice_prefix', 'INV-2016-00', 0),
(4131, 0, 'config', 'config_account_mail', '0', 0),
(4130, 0, 'config', 'config_account_id', '3', 0),
(4129, 0, 'config', 'config_login_attempts', '5', 0),
(4128, 0, 'config', 'config_customer_price', '0', 0),
(4127, 0, 'config', 'config_customer_group_display', '["1"]', 1),
(4126, 0, 'config', 'config_customer_group_id', '1', 0),
(4125, 0, 'config', 'config_customer_online', '0', 0),
(4124, 0, 'config', 'config_tax_customer', 'shipping', 0),
(4123, 0, 'config', 'config_tax_default', 'shipping', 0),
(4122, 0, 'config', 'config_tax', '1', 0),
(4121, 0, 'config', 'config_voucher_max', '1000', 0),
(4120, 0, 'config', 'config_voucher_min', '1', 0),
(4119, 0, 'config', 'config_review_mail', '0', 0),
(4118, 0, 'config', 'config_review_guest', '1', 0),
(4117, 0, 'config', 'config_review_status', '1', 0),
(4116, 0, 'config', 'config_product_mpn_hide', '0', 0),
(4115, 0, 'config', 'config_product_isbn_hide', '0', 0),
(4114, 0, 'config', 'config_product_jan_hide', '0', 0),
(4113, 0, 'config', 'config_product_ean_hide', '0', 0),
(4112, 0, 'config', 'config_product_upc_hide', '0', 0),
(4111, 0, 'config', 'config_limit_admin', '20', 0),
(4110, 0, 'config', 'config_product_description_length', '100', 0),
(4109, 0, 'config', 'config_product_limit', '12', 0),
(4108, 0, 'config', 'config_product_count', '1', 0),
(4107, 0, 'config', 'config_weight_class_id', '2', 0),
(4106, 0, 'config', 'config_length_class_id', '1', 0),
(4105, 0, 'config', 'config_currency_auto', '1', 0),
(4104, 0, 'config', 'config_currency', 'UAH', 0),
(4103, 0, 'config', 'config_admin_language', 'ru', 0),
(4102, 0, 'config', 'config_language', 'ru', 0),
(4101, 0, 'config', 'config_zone_id', '3487', 0),
(4100, 0, 'config', 'config_country_id', '220', 0),
(4099, 0, 'config', 'config_image', '', 0),
(4094, 0, 'config', 'config_geocode', '54.718681,20.499113', 0),
(4092, 0, 'config', 'config_template', 'fog', 0),
(4093, 0, 'config', 'config_layout_id', '4', 0),
(4091, 0, 'config', 'config_langdata', '{"1":{"meta_title":"Ghostly fog. \\u0417\\u0430\\u043b\\u0438\\u043b \\u0438 \\u0437\\u0430\\u043f\\u0430\\u0440\\u0438\\u043b!","meta_description":"\\u0418\\u043d\\u0442\\u0435\\u0440\\u043d\\u0435\\u0442 \\u043c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d \\u044d\\u043b\\u0435\\u043a\\u0442\\u0440\\u043e\\u043d\\u043d\\u044b\\u0445 \\u0441\\u0438\\u0433\\u0430\\u0440\\u0435\\u0442 \\u0438 \\u0436\\u0438\\u0434\\u043a\\u043e\\u0441\\u0442\\u0435\\u0439 \\u0432 \\u0423\\u043a\\u0440\\u0430\\u0438\\u043d\\u0435.","meta_keyword":"","name":"Ghostly fog","owner":"\\u041c\\u043e\\u0435 \\u0418\\u043c\\u044f","address":"\\u0410\\u0434\\u0440\\u0435\\u0441","open":"\\u041f\\u043d.-\\u041f\\u0442.: \\u0441 8:00 \\u0434\\u043e 20:00\\r\\n\\u0421\\u0431.-\\u0412\\u0441.: \\u0441 10:00 \\u0434\\u043e 18:00","comment":""},"2":{"meta_title":"Your Store","meta_description":"My Store","meta_keyword":"","name":"Your Store","owner":"Your Name","address":"Address 1","open":"","comment":""}}', 1),
(4098, 0, 'config', 'config_fax', '', 0),
(4097, 0, 'config', 'config_telephone2', '+38 (095) 708-98-79', 0),
(4096, 0, 'config', 'config_telephone', '+38 (093) 448-49-18 ', 0),
(4095, 0, 'config', 'config_email', 'alena.makarova1508@gmail.com', 0),
...
(4269, 0, 'bank_transfer', 'bank_transfer_total', '', 0),
(4270, 0, 'bank_transfer', 'bank_transfer_order_status_id', '2', 0),
(4271, 0, 'bank_transfer', 'bank_transfer_geo_zone_id', '0', 0),
(4272, 0, 'bank_transfer', 'bank_transfer_status', '1', 0),
(4273, 0, 'bank_transfer', 'bank_transfer_sort_order', '', 0);
...
--
ALTER TABLE `oc_dqc_statistic`
  MODIFY `statistic_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `oc_ocfilter_option_value_to_product`
  MODIFY `ocfilter_option_value_to_product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=189;
--
...
--
ALTER TABLE `oc_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=121;
--
-- AUTO_INCREMENT для таблицы `oc_order_product`
--
ALTER TABLE `oc_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=287;
--
...
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=626;
--
...
--
ALTER TABLE `oc_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=571;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4274;
--
...
--
ALTER TABLE `oc_url_alias`
  MODIFY `url_alias_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=918;
--
