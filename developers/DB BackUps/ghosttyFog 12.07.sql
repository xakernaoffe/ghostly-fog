...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 12 2017 г., 15:25
...
(19, 0, '1f9310m0kfmubmnn4ftiev6nm5', 43, 0, '[]', 3, '2017-07-12 14:24:56'),
(21, 0, '1f9310m0kfmubmnn4ftiev6nm5', 44, 0, '[]', 1, '2017-07-12 14:33:11'),
(22, 0, '1f9310m0kfmubmnn4ftiev6nm5', 48, 0, '[]', 1, '2017-07-12 14:53:10');
...
(37, 'Все новинки', 'latest', '{"name":"\\u0412\\u0441\\u0435 \\u043d\\u043e\\u0432\\u0438\\u043d\\u043a\\u0438","limit":"15","width":"200","height":"200","status":"1"}');
...
(47, 'Товар 21', '', '', '', '', '', '', '', 1000, 5, 'catalog/hogcob.png', 7, 1, '100.0000', 400, 9, '2009-02-03', '1.00', 1, '0.00', '0.00', '0.00', 1, 0, 1, 0, 1, 189, '2009-02-03 21:08:40', '2017-07-07 18:46:07'),
...
--
ALTER TABLE `oc_dqc_statistic`
  MODIFY `statistic_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=194;
--
...
--
ALTER TABLE `oc_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=122;
--
...
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=312;
--
...
--
ALTER TABLE `oc_url_alias`
  MODIFY `url_alias_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=899;
--
