<div class="container-fluid" id="support">
    <div class="row">
        <div class="col-md-4">
            ...
            <?php if (empty($data['labelmaker']['LicensedOn'])): ?>
            ...
            <table class="table notLicensedTable">
                <tr>
                    <td colspan="2"><div class="form-group">
                            ...
                            <input type="text" class="licenseCodeBox form-control" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" name="labelmaker[LicenseCode]" id="moduleLicense" value="<?php echo !empty($data['labelmaker']['LicenseCode']) ? $data['labelmaker']['LicenseCode'] : ''?>" />
                        </div>
            ...
            <?php endif; ?>
            <?php if (!empty($data['labelmaker']['LicensedOn'])): ?>
            <input name="cHRpbWl6YXRpb24ef4fe" type="hidden" value="<?php echo base64_encode(json_encode($data['labelmaker']['License'])); ?>" />
            <input name="OaXRyb1BhY2sgLSBDb21" type="hidden" value="<?php echo $data['labelmaker']['LicensedOn']; ?>" />
            <table class="table licensedTable">
                <tr>
                    <td>License Holder</td>
                    <td><?php echo $data['labelmaker']['License']['customerName']; ?></td>
                </tr>
                <tr>
                    <td>Registered domains</td>
                    <td><ul class="registeredDomains">
                            <?php foreach ($data['labelmaker']['License']['licenseDomainsUsed'] as $domain): ?>
                ...
                <tr>
                    ...
                    <td><?php echo date("F j, Y",strtotime($data['labelmaker']['License']['licenseExpireDate'])); ?></td>
                </tr>
                <tr>
        ...
        <div class="col-md-8">
            <div class="box-heading">
                <h3><i class="fa fa-group"></i>&nbsp;Get Support</h3>
            </div>
            <div class="box-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="thumbnail"> <img alt="Community support" style="width: 300px;" src="view/image/labelmaker/community.png">
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail"> <img data-src="holder.js/300x200" alt="Ticket support" style="width: 300px;" src="view/image/labelmaker/tickets.png">
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    <h3>Tickets</h3>
                                    <p>Want to comminicate one-to-one with our tech people? Then open a support ticket.</p>
                                    <p style="padding-top: 5px;"><a href="http://isenselabs.com/tickets/open/<?php echo base64_encode('Support Request').'/'.base64_encode('132').'/'. base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank" class="btn btn-lg btn-default">Open a support ticket</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="thumbnail"> <img alt="Pre-sale support" style="width: 300px;" src="view/image/labelmaker/pre-sale.png">
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    <h3>Pre-sale</h3>
                                    <p>Have a brilliant idea for your webstore? Our team of top-notch developers can make it real.</p>
                                    <p style="padding-top: 5px;"><a href="https://isenselabs.com/pages/premium-services" target="_blank" class="btn btn-lg btn-default">Bump the sales</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
