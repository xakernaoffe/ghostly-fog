                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="videos">
                        	<?php require_once(DIR_APPLICATION.'view/template/module/videopublisher/tab_videos.php'); ?>
                        </div>
                        <div class="tab-pane" id="collections">
                        	<?php require_once(DIR_APPLICATION.'view/template/module/videopublisher/tab_collections.php'); ?>
                        </div>
                        <div class="tab-pane" id="settings">
                        	<?php require_once(DIR_APPLICATION.'view/template/module/videopublisher/tab_settings.php'); ?>
                        </div>
                        <div class="tab-pane" id="isense_support">
                        	<?php require_once(DIR_APPLICATION.'view/template/module/videopublisher/tab_support.php'); ?>
                    	</div>
                    </div>
                </form>
            </div> 
