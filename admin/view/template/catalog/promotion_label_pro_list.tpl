          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($label['label_id'], $selected)) { ?>
                  ...
                  <td class="text-center"><?php if ($label['image']) { ?>
                    <img src="<?php echo $label['image']; ?>" alt="<?php echo $label['name']; ?>" class="img-thumbnail" />
                    <?php } else { ?>
