...
class Controllermodulevideopublisher extends Controller {
	...
	public function index() {
		...
		$this->load->language('module/videopublisher');
		...
		$data['button_edit'] = $this->language->get('button_edit');
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/videopublisher', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$data['submitReviewUrl'] = $this->url->link('module/videopublisher/addreview', 'token=' . $this->session->data['token'], 'SSL');
		$data['editReviewUrl'] = $this->url->link('module/videopublisher/editreview', 'token=' . $this->session->data['token'], 'SSL');
		$data['getReviewUrl'] = $this->url->link('module/videopublisher/getreview', 'token=' . $this->session->data['token'], 'SSL');
		$data['deleteReviewUrl'] = $this->url->link('module/videopublisher/deletereview', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['store']	= $store;
		$data['stores'] = $this->model_module_videopublisher->getSystemStores();
		...
		$data['reviews'] = $this->model_module_videopublisher->getAllReviews(false, $this->config->get('config_language_id'), $limit, $page);
		
		$pagination = new Pagination();
		$pagination->total = $this->model_module_videopublisher->getTotalReviews();
		$pagination->page = $page;
		$pagination->limit = $limit;
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('module/videopublisher', 'token=' . $this->session->data['token'] . '&page={page}&limit='.$limit, 'SSL');
		
		$data['pagination'] = $pagination->render();
		
		$data['addCollectionUrl'] = $this->url->link('module/videopublisher/addcollection', 'token=' . $this->session->data['token'], 'SSL');
		$data['deleteCollectionsUrl'] = $this->url->link('module/videopublisher/delcollections', 'token=' . $this->session->data['token'], 'SSL');
	
		$data['collections'] = array();
	
		$data['collections'] = $this->model_module_videopublisher->getCollections($page, $limit);
		...
		$this->response->setOutput($this->load->view('module/videopublisher.tpl', $data));
	}
	...
	public function addreview() {
		...
		$this->response->setOutput($this->load->view('module/'.$this->moduleName.'/review_form.php', $data));
	}
	...
	public function editreview() {
		...
		$data['videoReview'] = $this->model_module_videopublisher->getReview($pvr_id);
		$videoReviewsDescription = $this->model_module_videopublisher->getReviewDescription($pvr_id);
	...
	public function getreview() {
		if ($this->request->server['REQUEST_METHOD'] == 'GET' && !empty($this->request->get['review_id'])) {
			$this->load->model('module/videopublisher');
			echo json_encode($this->model_module_videopublisher->getReview($this->request->get['review_id']));
		}
	}
	...
	public function deletereview() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && !empty($this->request->post['review_id']) && $this->validateForm()) {
			$this->load->model('module/videopublisher');
			$pvr_id = $this->request->post['review_id'];
			$delete = $this->model_module_videopublisher->deleteReview($pvr_id);
			if ($delete !== false) {
	...
	public function getCollections() {
        ...
        $pagination->url			= $this->url->link('module/'.$this->moduleNameSmall.'/getCollections','token=' . $this->session->data['token'].'&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('module/'.$this->moduleNameSmall.'/view_collections.php', $data));
	}
	...
	public function addCollection() {
		...
		$this->response->setOutput($this->load->view('module/'.$this->moduleName.'/collection_form.php', $data));
	}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/videopublisher')) {
	...
	public function install() {
		$this->load->model('module/videopublisher');
		$this->model_module_videopublisher->createTable();
	}
	
	public function uninstall() {
		$this->load->model('module/videopublisher');
		$this->model_module_videopublisher->dropTable();
	}
	...
	private function upgradeIfNeeded() {
		...
		if (!$result->num_rows) {
			$this->model_module_videopublisher->createCollectionsTable();
		}
		$result = $this->db->query("SHOW COLUMNS FROM " .DB_PREFIX. "videopublisher LIKE 'collection_id';");
		if (!$result->num_rows) {
			$this->model_module_videopublisher->addCollectionColumn();
		}
	}
