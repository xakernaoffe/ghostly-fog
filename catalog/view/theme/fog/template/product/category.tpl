                                ...
                                <div class="product__thumb">
                                    ...
                                    <div class="product__thumb__caption">
                                        ...
                                        <div class="product__btn">
                                            ...
                                            <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" class="product__btn__button "><span class="product__btn__button__icon"></span><span class="product__btn__button__text hidden-xs hidden-sm hidden-md js-addToCart"><?php echo $button_cart; ?></span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
